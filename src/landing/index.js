      ...
      <div class="pt-24">
        <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
          <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
            <p class="uppercase tracking-loose w-full">What's cumulus?</p>
            <h1 class="my-4 text-5xl font-bold leading-tight">
              Install simply and track weakness!
            </h1>
            <p class="leading-normal text-2xl mb-8">
              Cumulus is a service that helps you monitor and fix security
      ...
      <section class="bg-white border-b py-8">
        <div class="container max-w-5xl mx-auto m-8">
          <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800">
            Just install, provide insights of security.
          </h1>
      ...
      <footer class="bg-white">
        <div class="container mx-auto px-8">
          <div class="w-full flex flex-col md:flex-row py-6">
            ...
            <div class="flex-1">
              <p class="uppercase text-gray-500 md:mb-6">Team</p>
            ...
            <div class="flex-1">
              <p class="uppercase text-gray-500 md:mb-6">Opensource</p>
              <ul class="list-reset mb-6">
                <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                  <a
